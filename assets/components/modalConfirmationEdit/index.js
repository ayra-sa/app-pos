    ...
    >
      <div className='modal-confirmation-add-kontainer'>
        <div className='flex justify-between w-100p mb-5'>
          <div className='modal-confirmation-add'>Konfirmasi Edit Data</div>
        ...
        <div className='mt-5 modal-confirmation-add-title-sub'>Apakah anda yakin akan mengedit data ini?</div>
...
export default ModalConfirmationEdit