  ...
  return (
    ...
    >
      <div>
        ...
        <div className='grid grid-cols-2 gap-4'>
          ...
          <div>
            ...
            <div className='mt-2 finance-penerimaan-modal-detail-field-value'>Sukarela</div>
          </div>
        </div>
        <div className='garis-tipis'></div>
        <DataTable
      ...
      <div className='flex justify-end mt-5'>
        ...
        }} className='cursor-pointer finance-penerimaan-modal-detail-button-edit mr-2'>Buku Simpanan</div>
