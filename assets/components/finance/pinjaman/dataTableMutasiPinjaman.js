      ...
      <div className='finance-simpanan-mutasi-table-wrapp'>
        <div className='finance-simpanan-mutasi-table-wrapp-sub'>
          ...
          <div className='finance-penerimaan-wrapp-search'>
            <ISearchInput />
            <input style={{ width: '95px' }} placeholder='cari' className='finance-penerimaan-wrapp-search-input' type="text" />
          </div>
...
export default DataTableMutasiPinjaman