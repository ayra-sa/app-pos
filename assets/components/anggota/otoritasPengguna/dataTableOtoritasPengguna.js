...
const DataTableOtoritasPengguna = ({
  urlCreatePenerimaan,
  setobjModalUp,
  objModalUp,
  isModalUp,
      ...
      cell: (row, index, column, id) => {
        return (
          <div className='display-flex-align-center'>
            ...
            <div className='cursor-pointer' onClick={() => setisModalConfirmationDelete(true)}>
              <IHapus />
            </div>
          </div>
        )
    ...
    <>
      <div className='finance-penerimaan-wrapp-second'>
        ...
        <div>
          ...
          <div onClick={() => setisModalTambahHakAkses(true)} style={{ width: '200px' }} className='finance-penerimaan-buttont-buat-wrapp'>
            <IAdd />
            <div className='finance-penerimaan-buttont-buat'>Tambah Admin</div>
          </div>
...
export default DataTableOtoritasPengguna