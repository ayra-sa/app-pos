...
const InputBarang = ({
    ...
    return (
        <>
            <div style={{ flex: flexParent }}>
                <div className={classTitle ? classTitle : 'mb-4px input-text-label'}>
                    {title}
                </div>
                <div className='d-flex justify-center align-center gap-10px'>
                    <input
                    ...
                    <div
                        ...
                        <select
                            ...
                            className='dropdown-status-data-table-select' name="cars" id="cars">
                            <option className='finance-penerimaan-create-dropdown-option' value="">Kg</option>
