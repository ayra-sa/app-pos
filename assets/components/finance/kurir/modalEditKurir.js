      ...
      <div className="h-100d-flex flex-column justify-between">
        <div>
          <div className="p-16px">
            <TitleModal title={`Edit Kurir`} setisModalClose={setisModal} />
          </div>
          ...
          >
            ...
            <div className="d-flex align-center jusitfy-end mb-16px pr-16px">
              <div className="d-flex gap-10px">
                ...
                />
                <ButtonSave title={"Edit"} action={() => handleActSubmit()} />
              </div>
            </div>
          </div>
        </div>
