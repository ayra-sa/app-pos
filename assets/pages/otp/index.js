...
const Otp = () => {
  const { auth_code } = useSelector((state) => state?.ResponLoginReducer);
            ...
            {({
              ...
              <form onSubmit={handleSubmit}>
                <div className="p-16px d-flex flex-column align-center">
                  ...
                  <div className="mt-16px wrapper-otp-title-sub">
                    Masukon kode OTP yang telah kami kirim ke no handphone anda
                  </div>
                </div>
