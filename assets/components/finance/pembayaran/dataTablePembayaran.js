  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (row, index, column, id) => {
        return (
          <div onClick={() => setisModalUp(true)} className='cursor-pointer'>
            <IEyes />
          </div>
        )
      }
  ...
  return (
    <>
      <div className='finance-penerimaan-wrapp-second'>
        ...
        <div>
          <Link href={urlCreatePenerimaan}>
            <div className='finance-penerimaan-buttont-buat-wrapp'>
              <IAdd />
              <div className='finance-penerimaan-buttont-buat'>Buat Pembayaran</div>
            </div>
          </Link>
        </div>
...
export default DataTablePembayaran