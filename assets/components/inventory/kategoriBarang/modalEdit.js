...
function ModalEditKategoriBarang({
  setisModal,
  isModalUp,
  handleActCancel,
  handleActSubmit,
      ...
      <div className="h-100d-flex flex-column justify-between">
        <div>
          <div className="p-16px">
            <TitleModal title={`Edit Kategori`} setisModalClose={setisModal} />
          </div>
          ...
          >
            <div className="p-16px grid grid-cols-1 gap-4">
              <InputText
                ...
                value={category?.name}
                handleChange={(e) => 
                  setCategoryToEdit && setCategoryToEdit(prev => ({
                    ...prev,
                    name: e.target.value
                  }))
                }
              ...
              <UploadImage flex={1} onImageUpload={handleImageChange} />
...
export default ModalEditKategoriBarang;
