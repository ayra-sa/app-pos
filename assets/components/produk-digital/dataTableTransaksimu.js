...
const DataTableTransaksimu = ({
  ...
  const columns = [
    ...
    {
      name: 'Nama Produk',
      selector: row => row.namProduk,
    },
    {
      name: 'Type Produk',
      selector: row => row.typeProduk,
    },
    {
      name: 'Nomor Tujuan',
      selector: row => row.noTujuan,
    },
    {
      name: 'Harga',
  ...
  return (
    <>
      <div className='finance-penerimaan-wrapp-second'>
        ...
        <div>
          <Link href={'/produk-digital/transaksimu'}>
...
export default DataTableTransaksimu