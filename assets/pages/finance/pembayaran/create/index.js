...
const CreatePembayaran = () => {
  ...
  const SimpanAct = () => {
    ...
    router.push('/finance/pembayaran/')
  }
    ...
    <Admin>
      <div className='finance-penerimaan-create-kontainer'>
        <div className='finance-penerimaan-create-title-wrapp'>
          ...
          <div className='finance-penerimaan-create-title'>Buat Pembayaran</div>
        </div>
        ...
        <div className='grid grid-cols-1 mt-4 gap-4'>
          <div className='flex justify-end'>
            ...
            <div
              ...
              className='cursor-pointer finance-penerimaan-create-btn-simpan'>Simpan</div>
          </div>
        </div>
      </div>
...
export default WithAuth(CreatePembayaran)