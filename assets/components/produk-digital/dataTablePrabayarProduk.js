      ...
      cell: (row, index, column, id) => {
        return (
          <div className='cursor-pointer' onClick={() => setisModalUp(true)}>
            ...
            <div className='btn-produk-margin'>
              <div className='btn-produk-margin-title'>Margin</div>
            </div>
...
export default DataTablePrabayarProduk