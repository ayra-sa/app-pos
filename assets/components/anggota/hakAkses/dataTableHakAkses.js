      ...
      cell: (row, index, column, id) => {
        return (
          <div className='display-flex-align-center'>
            <div className='cursor-pointer mr-2' onClick={() => setisModalTambahHakAkses(true)}>
              <IEyes />
            </div>
            <div
      ...
      <div className='finance-penerimaan-wrapp-second'>
        ...
        <div>
          ...
          <div onClick={() => setisModalTambahHakAkses(true)} style={{ width: '200px' }} className='finance-penerimaan-buttont-buat-wrapp'>
            <IAdd />
            <div className='finance-penerimaan-buttont-buat'>Tambah Akses</div>
          </div>
...
export default DataTableHakAkses