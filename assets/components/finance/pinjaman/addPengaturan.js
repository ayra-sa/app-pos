  ...
  return (
    <div className='finance-simpanan-add-pengaturan-kontainer'>
      <div className='finance-simpanan-add-pengaturan-top-wrapp'>
        ...
        <div className='finance-simpanan-add-pengaturan-top-title'>Tambah Pinjaman</div>
      </div>
      <div className='garis-tipis'></div>
      <div className='finance-simpanan-add-pengaturan-top-title-sub'>Detail Umum</div>
      <div className='garis-tebal'></div>

      <div>
        <div className='finance-simpanan-add-pengaturan-top-title-sub'>Type Pinjaman</div>
