...
const DataTablePenjualan = ({
  urlCreatePenerimaan,
  setobjModalUp,
  objModalUp,
  isModalUp,
  setisModalUp,
  setisModalPenjualanDetail,
}) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (row, index, column, id) => {
        return (
          <div className='cursor-pointer' onClick={() => setisModalPenjualanDetail(true)}>
            <IEyes />
          </div>
        )
      }
  ...
  return (
    <>
      <div className='finance-penerimaan-wrapp-second'>
        ...
        <div>
          <ButtonTambah action={() => {
            router.push('/finance/penjualan/create')
