  ...
  return (
    ...
    >
      <div className='modal-confirmation-add-kontainer'>
        ...
        <div className='mt-5 modal-confirmation-add-title-sub'>Apakah anda yakin akan membuat data ini?</div>
...
export default ModalConfirmationAdd