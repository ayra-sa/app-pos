      ...
      <div style={{
        ...
        <div className='d-flex flex-column gap-16px p-16px'>
          ...
          <div className='d-flex'>
            ...
            <div className='d-flex flex-column gap-4px flex-1'>
              <div className='detail-buku-pinjaman-deskripsi'>Sisa Tenor (Bln)</div>
              <div className='detail-buku-pinjaman-deskripsi-sub'>Sisa Tenor (Bln)</div>
            </div>
          </div>
        </div>

        <div className='grid grid-cols-1 gap-4 pl-16px pr-16px'>
          <InputDropdownvalue
            flexParent={1}
            title={'Jumlah Bulan'}
          ...
          // value={group_code}
          // setValue={setgroup_code}
          />
        </div>

        <div className='d-flex flex-column gap-8px pl-16px pr-16px pt-16px'>
          <div className='detail-buku-pinjaman-jumlah-bayar'>Jumlah tagihan</div>
          <div className='detail-buku-pinjaman-jumlah-bayar-sub'>Rp 100.000</div>
        </div>

        <div className='d-flex justify-end p-16px'>
          <div className='d-flex gap-16px'>
            <ButtonCancel action={() => setisModalUp(false)} paddingTop={'6px'} title={'Tutup Pinjaman'} />
            <ButtonSave action={() => setisModalConfirmationAdd(true)} title={'Bayar Pinjaman'} />
          </div>
        </div>
...
export default ModalBayarPinjaman